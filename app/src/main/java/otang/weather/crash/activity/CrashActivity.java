package otang.weather.crash.activity;
...
import otang.weather.crash.config.CrashConfig;

public final class CrashActivity {

	private final static String TAG = "CrashActivity";
	//Extras passed to the error activity
	private static final String EXTRA_CONFIG = "otang.weather.EXTRA_CONFIG";
	private static final String EXTRA_STACK_TRACE = "otang.weather.EXTRA_STACK_TRACE";
	private static final String EXTRA_ACTIVITY_LOG = "otang.weather.EXTRA_ACTIVITY_LOG";
	//General constants
	private static final String INTENT_ACTION_ERROR_ACTIVITY = "otang.weather.ERROR";
	private static final String INTENT_ACTION_RESTART_ACTIVITY = "otang.weather.RESTART";
	private static final String CRASH_HANDLER_PACKAGE_NAME = "otang.weather.";
	private static final String DEFAULT_HANDLER_PACKAGE_NAME = "com.android.internal.os";
	private static final int MAX_STACK_TRACE_SIZE = 131071; //128 KB - 1
	private static final int MAX_ACTIVITIES_IN_LOG = 50;
	//Shared preferences
	private static final String SHARED_PREFERENCES_FILE = "otang.weather_preferences";
